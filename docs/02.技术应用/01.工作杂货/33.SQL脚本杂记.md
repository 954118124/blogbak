...
````
<img src="/img/media/img_gzzh_1.png" class="imgcss" width="70%">
...
<img src="/img/media/img_gzzh_2.png" class="imgcss" width="70%">
...
<img src="/img/media/img_gzzh_3.png" class="imgcss" width="70%">

## 2 Oracle查询库表所有列
````sql
select a.column_name 列名, b.COMMENTS 注释
from all_tab_columns a
left join user_col_comments b on a.COLUMN_NAME = b.COLUMN_NAME and a.TABLE_NAME = b.TABLE_NAME
where a.Table_Name='TAB_xxx_xxx';
````