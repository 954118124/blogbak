...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '知识整理',
        link: '/pages/5aa878/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
      },
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/star.png' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
  ...
  plugins: <UserPlugins>[
    ...
    //       owner: '954118124', // GitHub仓库所有者
    //       admin: ['954118124'], // 对仓库有写权限的人
